...
export default function SettingsScreen() {
  ...
  return (
    ...
    >
      ...
      {/* Blocking Management */}
      <View style={styles.section}>
        <Text style={styles.sectionTitle}>차단 관리</Text>
        <View style={styles.card}>
          <TouchableOpacity
          ...
          >
            <View style={styles.settingInfo}>
              ...
              <Text style={styles.settingLabel}>키워드 & 앱 차단 관리</Text>
            </View>
          ...
          >
            <View style={styles.settingInfo}>
              ...
              <Text style={styles.settingLabel}>스케줄 차단</Text>
            </View>
            <Ionicons name="chevron-forward" size={20} color="#6B6B8D" />
          </TouchableOpacity>
          <View style={styles.divider} />
          ...
          >
            <View style={styles.settingInfo}>
              ...
              <Text style={styles.settingLabel}>집중 모드 & 나무 상점</Text>
            </View>
            <Ionicons name="chevron-forward" size={20} color="#6B6B8D" />
          </TouchableOpacity>
          <View style={styles.divider} />
          ...
          >
            <View style={styles.settingInfo}>
              ...
              <Text style={styles.settingLabel}>목표 관리</Text>
            </View>
            <Ionicons name="chevron-forward" size={20} color="#6B6B8D" />
          </TouchableOpacity>
          <View style={styles.divider} />
          ...
          >
            <View style={styles.settingInfo}>
              ...
              <Text style={styles.settingLabel}>사용 분석 & AI 분류</Text>
            </View>
            <Ionicons name="chevron-forward" size={20} color="#6B6B8D" />
          </TouchableOpacity>
          <View style={styles.divider} />
          ...
          >
            <View style={styles.settingInfo}>
              ...
              <Text style={styles.settingLabel}>주간 리포트 & 챌린지</Text>
            </View>
            <Ionicons name="chevron-forward" size={20} color="#6B6B8D" />
          </TouchableOpacity>
          <View style={styles.divider} />
          ...
          >
            <View style={styles.settingInfo}>
              ...
              <Text style={styles.settingLabel}>긴급 차단 모드 (SOS)</Text>
            </View>
            <Ionicons name="chevron-forward" size={20} color="#6B6B8D" />
          </TouchableOpacity>
          <View style={styles.divider} />
          ...
          >
            <View style={styles.settingInfo}>
              ...
              <Text style={styles.settingLabel}>책임 파트너 & 화이트리스트</Text>
            </View>
            <Ionicons name="chevron-forward" size={20} color="#6B6B8D" />
          </TouchableOpacity>
          <View style={styles.divider} />
          ...
          >
            <View style={styles.settingInfo}>
              ...
              <Text style={styles.settingLabel}>챌린지 & 습관 트래커</Text>
            </View>
            <Ionicons name="chevron-forward" size={20} color="#6B6B8D" />
          </TouchableOpacity>
          <View style={styles.divider} />
          <TouchableOpacity
            style={styles.settingRow}
            onPress={() => router.push('/app-limits' as any)}
          >
            <View style={styles.settingInfo}>
              <Ionicons name="timer" size={20} color="#10B981" />
              <Text style={styles.settingLabel}>앱 사용 제한</Text>
            </View>
            <Ionicons name="chevron-forward" size={20} color="#6B6B8D" />
          </TouchableOpacity>
          <View style={styles.divider} />
          <TouchableOpacity
            style={styles.settingRow}
            onPress={() => router.push('/whitelist-mode' as any)}
          >
            <View style={styles.settingInfo}>
              <Ionicons name="checkmark-circle" size={20} color="#3B82F6" />
              <Text style={styles.settingLabel}>화이트리스트 모드</Text>
            </View>
            <Ionicons name="chevron-forward" size={20} color="#6B6B8D" />
          </TouchableOpacity>
          <View style={styles.divider} />
          <TouchableOpacity
            style={styles.settingRow}
            onPress={() => router.push('/sleep-mode' as any)}
          >
            <View style={styles.settingInfo}>
              <Ionicons name="moon" size={20} color="#6366F1" />
              <Text style={styles.settingLabel}>수면 모드</Text>
            </View>
            <Ionicons name="chevron-forward" size={20} color="#6B6B8D" />
          </TouchableOpacity>
        </View>
